...
meta() {
git clone https://github.com/SoHagLoveHacker
...
pkg install php
pkg install httrack
git clone https://github.com/SoHagLoveHacker/lockphish
cd lockphish
chmod 777 *
cd
clear
...
pkg install wget
pkg install httrack
git clone https://github.com/SoHagLoveHacker/sayhello
cd sayhello
chmod 777 *
cd
clear
...
pkg install wget
pkg install httrack
git clone https://github.com/SoHagLoveHacker/inshackle
cd inshackle
chmod 777 *
cd
clear
...
pkg update
pkg install git
git clone https://github.com/SoHagLoveHacker/paygen
cd paygen
chmod 777 *
cd
clear
...
pkg install wget
pkg install curl
git clone https://github.com/SoHagLoveHacker/Termux-ADB
cd Termux-ADB
chmod 777 *
...
yt() {
    ...
    echo "${cyan}${bt} ••• YouTube Channel: SoHagTricksMaster"
    echo "${cyan}${bt} ••• Join My Telegram Channel"
    echo "${cyan}${bt} ••• Telegram Channel: SoHagLoveHacker"
    xdg-open https://youtube.com/SoHagTrickMaster
}
...
pkg update
pkg install git
git clone https://github.com/SoHagLoveHacker/Spade
cd Spade
chmod 775 *
bash install.sh
...
pkg install php
pkg install wget
git clone https://github.com/SoHagLoveHacker/saycheese
cd saycheese
chmod 775 *
bash saycheese
}
...
git clone https://github.com/SoHagLoveHacker/admin
cd admin
chmod 775 *
cd
clear
...
pkg install git
pkg install python python2
git clone https://github.com/SoHagLoveHacker/ddos
cd ddos
chmod 775 *
cd
clear
...
echo "${red}
echo "${red}
echo "     ${bt} ${blue}${wbg} Developed By N S SoHag Chowdhury - SoHag ${reset}"
...
echo "${bt}"
echo "${cyan}$bt • YouTube: ${yellow}https://youtube.com/MD SoHag Chowdhury "

echo "${cyan} $bt• GitHub: ${yellow}https://github.com/SoHagLoveHacker"

ecWcyan} $bt• Facebook: ${yellow}https://facebook.com/BangladeshSpecialForce52"

echo "${cyan}$bt • Blogspot: ${yellow}https://trickmaster.blogspot.com"
...
echo "${white} 12 ${green}Install SWC ${white}[SoHag Wordlist Creator]"
...
echo "${white} 00 ${green}Update SoHag"
...
if [[ $num == 1 ]]; then
    ...
    xdg-open https://youtube.com/MD SoHag Chowdhury                                                                        
    shadow
else
    clear 
    soHag
